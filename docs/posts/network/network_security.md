...
| Users can only reach end services via the User-Gate to end Traefik proxy chain (refer to [Traffic Flow](traffic_flow.md)).        | Edgeshark which requires a direct two way connection with the user.                                                                                                                                                                                                                                      |
